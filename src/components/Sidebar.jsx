    ...
    return (
        <>
            <div className='mr-12 md:m-0 bg-[#09121f]'>
                ...
                <div
                    className={
                        `bg-[#09121f] text-white absolute top-0 md:static inset-y-0 left-0 mt-20 md:mt-0 
                        ${isOpen ? "translate-x-0" : "-translate-x-full"} w-64 transition-transform duration-300 ease-in-out z-40 md:translate-x-0`}
                >
